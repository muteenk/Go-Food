...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="absolute top-0 left-0 z-50 w-screen shadow-[0_20px_50px_-15px_rgba(0,0,0,0.4)] flex justify-between items-center lg:px-3 min-[1420px]:px-[5em] px-6 py-4 lg:py-8 bg-priColor lg:bg-[transparent] lg:shadow-none">
